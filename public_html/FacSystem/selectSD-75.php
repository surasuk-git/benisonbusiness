...
<html>
<head>
<title>รางครอบท่อ - Facoty System Benison Business Co., Ltd.</title>
...
<div class="container-fluid mySlides">
	<div class="row">
			<table class="show1" style="margin:0;">
				...
				<tr>
					<th width="50%" style="background-color:#9966CC;color:#fff;">HARU</th>
				</tr>
			</table>
	</div>
	<div class="row">
		...
		<div class="col-xs-8 col-md-8">
			...
			$resultBoxM = $goalBoxM - $TotalMonthBox  ;
			$today = date('d') ;
			...
			@$DayNow = date('z');
			@$NumDayNow = $DayNow;
			@$goalStandard = $NumDayNow * 600 ;
			$NumBoxToGoal = $goalStandard-$totalBox ;
			$NumDayToGoal = $NumBoxToGoal / 600 ;
			$DayOfGoal = 300;
			$DayOfYear = ($DayOfGoal - $DayNow) + ($NumDayToGoal);
			?>
			  <table border="0" class="show2">
				...
				<tr>
					...
					<td class="quanM"><p><?php echo number_format("$TotalMonthBox")?></p></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="para"><p>จำนวนวัน</p></td>
					<td class="para"><p>คงเหลือ (ปี)</p></td>
					<td class="quan"><p><?php echo number_format("$DayOfYear")?>  วัน</p></td>
					<td class="para"><p>ตามหลัง</p></td>
					<td class="quan"><p><?php echo number_format("$NumDayToGoal")?>  วัน</p></td>
				</tr>
				<tr>
					<td class="para"><p>จำนวนกล่องที่ตามหลัง</p></td>
					<td class="quan" colspan="3"><p><?php echo number_format("$NumBoxToGoal")?></p></td>
...
function carousel() {
  ...
  setTimeout(carousel, 20000); // Change image every 20seconds
}
</script>
